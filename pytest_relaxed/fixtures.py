...
# TODO: consider making this a "no param required" fixture and have uses of it
# simply call os.environ as normal. Pro: test code looks less magical, con:
# removes any ability to do anything more interesting with the yielded value
# (like proxying or whatever.) See the pytest 3.1.2 docs at:
